...
log_level = 'INFO'
work_dir = './work_dirs/visdrone_sota_full_pg2streamcascade_rcnn_r18_fpn_1x'
load_from = None
resume_from = './work_dirs/visdrone_sota_full_pg2streamcascade_rcnn_r18_fpn_1x/epoch_1.pth'
workflow = [('train', 1)]

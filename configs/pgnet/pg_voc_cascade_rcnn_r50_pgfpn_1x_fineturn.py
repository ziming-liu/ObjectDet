...
# learning policy
lr_config = dict(policy='step', step=[4,6,])  # actual epoch = 3 * 3 = 9
...
log_level = 'INFO'
work_dir = './work_dirs/pg_voc_cascade_rcnnmod2_r50_pgfpn_1x_fineture'
load_from = './work_dirs/pg_voc_cascade_rcnnmod2_r50_pgfpn_1x/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]

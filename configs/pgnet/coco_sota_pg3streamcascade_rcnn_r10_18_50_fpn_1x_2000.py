...
model = dict(
    ...
    neck=dict(
        type='PGFPN3s',
        in_channels=[256//4, 512//4, 1024//4, 2048//4, 256//4, 512//4, 1024//4, 2048//4, 256, 512, 1024, 2048],
        out_channels=256,
        num_outs=5),
    rpn_head=dict(
        type='RPNHead',
...
log_level = 'INFO'
work_dir = './work_dirs/coco_sota_pg3streamcascade_rcnn_r10_18_50_fpn_1x_2000'

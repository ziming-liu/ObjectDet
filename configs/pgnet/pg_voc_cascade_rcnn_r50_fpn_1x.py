...
log_level = 'INFO'
work_dir = './work_dirs/pg_voc_cascade_rcnn_r50_fpn_1x'
load_from = './work_dirs/pg_voc_cascade_rcnn_r50_fpn_1x/epoch_12.pth'
resume_from = None#'./work_dirs/pg_voc_cascade_rcnn_r50_fpn_1x/epoch_12.pth'
workflow = [('train', 1)]

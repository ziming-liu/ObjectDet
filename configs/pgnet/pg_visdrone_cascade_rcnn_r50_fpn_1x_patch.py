...
log_level = 'INFO'
work_dir = './work_dirs/pg_cascade_rcnn_r50_fpn_1x_visdrone_pathch'
load_from = None
resume_from = './work_dirs/pg_cascade_rcnn_r50_fpn_1x_visdrone_pathch/epoch_12.pth'
workflow = [('train', 1)]

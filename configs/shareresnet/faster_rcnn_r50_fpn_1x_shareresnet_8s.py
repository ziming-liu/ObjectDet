...
model = dict(
    ...
    backbone=dict(
        ...
        gcb=None,
        stage_with_gcb=(False, False, False, False,False, False, False,False),
        gen_attention=None,
    ...
    neck=dict(
        type='FPN',
        in_channels=[256, 512, 1024, 2048, 2048, 2048, 2048,2048],
        out_channels=256,
        keep=0,
        num_outs=8),
    rpn_head=dict(
        ...
        anchor_strides=[4, 8, 16, 32, 64,128,256,512],
    ...
    bbox_roi_extractor=dict(
        ...
        out_channels=256,
        featmap_strides=[4, 8, 16, 32, 64,128,256,512]),
    bbox_head=dict(
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_shareresnet_8s'
load_from = None

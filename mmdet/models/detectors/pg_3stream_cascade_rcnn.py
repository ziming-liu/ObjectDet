...
class PG3streamCascadeRCNN(BaseDetector, RPNTestMixin,BBoxTestMixin):
    ...
    def __init__(self,
        ...
        super(PG3streamCascadeRCNN, self).__init__()

        self.num_stages = num_stages
        self.backbone = builder.build_backbone(backbone)
        self.backbone_deep = builder.build_backbone(backbone_deep)
        self.backbone_deeper = builder.build_backbone(backbone_deeper)
    ...
    def init_weights(self, pretrained=None):
        super(PG3streamCascadeRCNN, self).init_weights(pretrained)
        self.backbone.init_weights(pretrained=pretrained)
        self.backbone_deep.init_weights(pretrained=pretrained)
        self.backbone_deeper.init_weights(pretrained=pretrained)
    ...
    def extract_feat(self, img):
        ...
        x_smaller = F.interpolate(img, scale_factor=0.25, mode='nearest')
        #print(x_large.shape)
        # print(x_mid.shape)
        # print(x_small.shape)
        ...
        x_smaller = self.backbone_deeper(x_smaller)
        input = list()
        input.extend(x_large)
        input.extend(x_small)
        input.extend(x_smaller)
    ...
    def show_result(self, data, result, img_norm_cfg, **kwargs):
        ...
        super(PG3streamCascadeRCNN, self).show_result(data, result, img_norm_cfg,
                                             **kwargs)

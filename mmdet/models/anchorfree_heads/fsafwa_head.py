...
class FSAFHead(nn.Module):
    ...
    def forward_single(self, x): # anchor free forward
        cls_feat = x
        reg_feat = x
        ...
        return cls_score, bbox_pred # classore is tuple
    ...
    def loss(self,
        ...
        losses_cls, losses_reg = multi_apply(
            ...
            cfg=cfg)
        # anchor head single loss
        # returen loss_anchorefree cl  loss anchorcls  loss anchor reg  loss anchorefree reg
    ...
    def get_bboxes_single(self, # anchor free ,, need anchore head get box
                          cls_scores,
                          bbox_preds,
                          mlvl_points,
                          img_shape,
        ...
        mlvl_bboxes = torch.cat(mlvl_bboxes) ## combine
        if rescale:

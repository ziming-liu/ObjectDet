...
class IPN_independ(nn.Module):
    ...
    def __init__(self,
        ...
        super(IPN_independ, self).__init__()
        ...
        for i, num_blocks in enumerate(self.stage_blocks):
            ...
            self.res_layers.append(layer_i)
    ...
    def forward(self, input):
        ...
        outs = []
        for jj in range(self.num_stages):# stream
            for ii in range(0,jj+1):# layer num
                layer_name = self.res_layers[ii][self.num_stages-jj-1]
    ...
    def train(self, mode=True):
        super(IPN_independ, self).train(mode)
        self._freeze_stages()

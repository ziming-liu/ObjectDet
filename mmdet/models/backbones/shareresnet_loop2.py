...
class shareResNet_loop2(nn.Module):
    """ResNet backbone.
    ...
    def __init__(self,
        ...
        super(shareResNet_loop2, self).__init__()
        ...
        for i, num_blocks in enumerate(self.stage_blocks):
            ...
            if i>=3:
                layer_name = 'layer_keep{}'.format(i + 1)
            else:
    ...
    def forward(self, input):
        ...
        for loop in range(2):
            ...
            res_layer = getattr(self, self.res_layers[0])
            x2 = res_layer(x2)
            x2 = self.conv256_1024(x2)
            outs[2] = x2 + high_sem + outs[2]
            for i in range(3,len(self.res_layers)):
    ...
    def train(self, mode=True):
        super(shareResNet_loop2, self).train(mode)
        self._freeze_stages()

...
class shareResNet_blue_conv(nn.Module):
    """ResNet backbone.
    ...
    def __init__(self,
        ...
        super(shareResNet_blue_conv, self).__init__()
        ...
        self.conv256_512 = ConvModule(
            256, 512,
            1,
            conv_cfg=conv_cfg,
            norm_cfg=norm_cfg,
            inplace=False)
        self.conv256_1024 = ConvModule(
            256,1024,
            1,
            conv_cfg=conv_cfg,
            norm_cfg=norm_cfg,
            inplace=False)
        self.conv256_2048 = ConvModule(
            256,2048,
            1,
            conv_cfg=conv_cfg,
            norm_cfg=norm_cfg,
    ...
    def train(self, mode=True):
        super(shareResNet_blue_conv, self).train(mode)
        self._freeze_stages()

...
__all__ = ['ResNet', 'Kite','Updown', 'shareResNet','shareResNet_desh','shareResNet_loop2', 'shareResNet_loop','IPN_share','KiteX', 'SSDVGGkite','IPN_kite','IPN_fusing', 'ResNetS','make_res_layer','IPN_sharev2', 'ResNeXt', 'SSDVGG', 'HRNet']
